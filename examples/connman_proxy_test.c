...
gboolean
connman_proxy_test_input_cb (connman_mgr_request_input_type_t input_type, gpointer cookie)
{
...
gboolean
connman_proxy_test_update_cb (connman_proxy_update_cb_data_t *notification_data, gpointer cookie)
{
  gboolean ret = TRUE;
...
void *
connman_on_key_pressed (void *user_data)
{
  int32_t c = 0;
  connman_proxy_handler_t *connman_proxy_handler = (connman_proxy_handler_t *) user_data;
  connman_proxy_technology_info_t *tmp_tech = NULL;
